...
This repository contains the final assignment for the Data Science with Python course. The assignment involves using Python libraries to extract, analyze, and visualize stock and revenue data for Tesla and GameStop.
